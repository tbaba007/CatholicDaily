...
const EditHomily=(props)=>{
    let {Title,Homily,id,date}=props.route.params
    const [title,setTitle]=useState(Title);
    const [homily,setHomily]=useState(Homily);
    ...
    const saveHomily=()=>{
        ...
        messageStorage.saveMessage(id,JSON.stringify({title:title,homily:homily}));
